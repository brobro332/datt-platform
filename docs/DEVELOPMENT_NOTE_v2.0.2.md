...
### 📅 2026-07-25: ES custom HttpHeaders 순정화, wave-messaging DB 통합 및 Kafka Map 역직렬화 패치
* `cbe8646` - **ES custom HttpHeaders 순정화, wave-messaging DB 통합 및 Kafka Map 역직렬화 패치**
    * **작업 내용**:
