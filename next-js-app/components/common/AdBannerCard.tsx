...
export function AdBannerCard({ ad }: AdBannerCardProps) {
  ...
  return (
    <aside className="hidden xl:flex w-[200px] shrink-0 sticky top-24 self-start h-[540px] rounded-[2.5rem] border border-slate-200/50 bg-white/70 backdrop-blur-md p-5 shadow-sm flex-col justify-between overflow-hidden group hover:shadow-md transition-all duration-300">
      ...
      <div className="relative z-10 space-y-4 flex-1 flex flex-col justify-end mt-4">
        {/* Carousel Image Area */}
        <div className="flex-1 rounded-2xl border border-slate-200/30 overflow-hidden relative group/img shadow-inner min-h-[160px]">
